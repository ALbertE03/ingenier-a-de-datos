...
export function Auth() {
  ...
  return (
    <div className="w-full max-w-4xl p-6 md:p-8 rounded-3xl border border-white/10 bg-black/40 backdrop-blur-xl shadow-2xl transition-all duration-500 hover:border-white/15 relative overflow-hidden group">
      ...
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center pb-6 border-b border-white/10 gap-4 mb-6">
        <div>
          <div className="flex items-center gap-2">
            ...
            <h2 className="text-xl font-bold text-white">Sesión Inicializada</h2>
          </div>
          <p className="text-sm text-slate-400 mt-1">
            Consola interactiva para verificar acceso y autenticación
          </p>
        </div>
        ...
        <div className="lg:col-span-5 space-y-4">
          ...
          {endpoints.map((endpoint) => (
            <button
              ...
              className={`w-full text-left p-4 rounded-2xl border transition-all duration-300 active:scale-[0.99] cursor-pointer flex flex-col gap-1 ${activeEndpoint === endpoint.path
                ? endpoint.id === 'public'
            ...
            >
              <div className="flex items-center justify-between">
                ...
                <span className={`text-[10px] px-2 py-0.5 rounded-full font-bold uppercase tracking-wider flex items-center gap-0.5 ${endpoint.id === 'public'
              ...
              <code className={`text-[10px] mt-2 font-mono ${endpoint.id === 'public'
                ? "text-cyan-300"
                : endpoint.id === 'user'
                  ? "text-violet-300"
                  : "text-rose-300"
